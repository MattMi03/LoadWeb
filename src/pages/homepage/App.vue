...
export default {
  ...
  methods: {
    pageSelect(page) {
      switch (page) {
        case 0:
          this.currentComponent = 'MainWindow';
          break;
        case 1:
          this.currentComponent = 'RiskManagement';
          break;
        case 2:
        ...
        case 4:
          ...
          break;
        case 5:
          this.currentComponent = 'LoanHandle';
          break;
        default:
          this.currentComponent = 'MainWindow';
          break;
...
.list .pages button {
  ...
  background-image: url(~@/assets/images/button2.png) no-repeat;
}
...
.list .pages button:active::before {
  opacity: 0.1;
}
